  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shopping_cart as @shopping_cart" do
        ...
        post :create, {:shopping_cart => { "customer_token" => "invalid value" }}, valid_session
        assigns(:shopping_cart).should be_a_new(ShoppingCart)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shopping_cart" do
        ...
        ShoppingCart.any_instance.should_receive(:update_attributes).with({ "customer_token" => "MyString" })
        put :update, {:id => shopping_cart.to_param, :shopping_cart => { "customer_token" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the shopping_cart as @shopping_cart" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ShoppingCart.any_instance.stub(:save).and_return(false)
        put :update, {:id => shopping_cart.to_param, :shopping_cart => { "customer_token" => "invalid value" }}, valid_session
        assigns(:shopping_cart).should eq(shopping_cart)
      end
